...
namespace Hitem3D
{
    public partial class TasksClient
    {
        ...
        {
            var __response = await SubmitTaskAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Hitem3D.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Hitem3D.AutoSDKHttpResponse<global::Hitem3D.SubmitTaskEnvelope>> SubmitTaskAsResponseAsync(
                    ...
                    await global::Hitem3D.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Hitem3D.SubmitTaskEnvelope.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Hitem3D.AutoSDKHttpResponse<global::Hitem3D.SubmitTaskEnvelope>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Hitem3D.SubmitTaskEnvelope.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::Hitem3D.SubmitTaskRequest
            {
                RequestType = requestType,
                Model = model,
                Images = global::System.Array.Empty<byte>(),
                Imagesname = imagesname,
                MultiImages = global::System.Array.Empty<byte>(),
                MultiImagesname = multiImagesname,
                MultiImagesBit = multiImagesBit,
                Resolution = resolution,
                MeshUrl = meshUrl,
                Mesh = global::System.Array.Empty<byte>(),
                Meshname = meshname,
                Pbr = pbr,
                Face = face,
                Format = format,
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (multiImages != default)
                            {

                                var __contentMultiImages = new global::System.Net.Http.StreamContent(multiImages);
                                __contentMultiImages.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.MultiImagesname is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.MultiImagesname) ?? string.Empty).ToLowerInvariant() switch
                            ...
                            if (mesh != default)
                            {
                                ...
                                var __contentMesh = new global::System.Net.Http.StreamContent(mesh);
                                __contentMesh.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.Meshname is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.Meshname) ?? string.Empty).ToLowerInvariant() switch
