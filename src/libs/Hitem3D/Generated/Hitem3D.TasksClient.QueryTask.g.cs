...
namespace Hitem3D
{
    public partial class TasksClient
    {
        ...
        private static readonly global::Hitem3D.EndPointSecurityRequirement s_QueryTaskSecurityRequirement0 =
        ...
        private static readonly global::Hitem3D.EndPointSecurityRequirement[] s_QueryTaskSecurityRequirements =
            new global::Hitem3D.EndPointSecurityRequirement[]
            {                s_QueryTaskSecurityRequirement0,
            };
        partial void PrepareQueryTaskArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string taskId);
        partial void PrepareQueryTaskRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string taskId);
        partial void ProcessQueryTaskResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessQueryTaskResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Hitem3D.TaskEnvelope> QueryTaskAsync(
            string taskId,
            global::Hitem3D.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await QueryTaskAsResponseAsync(
                taskId: taskId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Hitem3D.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Hitem3D.AutoSDKHttpResponse<global::Hitem3D.TaskEnvelope>> QueryTaskAsResponseAsync(
            string taskId,
            global::Hitem3D.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Hitem3D.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_QueryTaskSecurityRequirements,
                operationName: "QueryTaskAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Hitem3D.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Hitem3D.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "QueryTaskAsync",
                                pathTemplate: "\"/open-api/v1/query-task\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Hitem3D.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessQueryTaskResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Hitem3D.TaskEnvelope.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Hitem3D.AutoSDKHttpResponse<global::Hitem3D.TaskEnvelope>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Hitem3D.TaskEnvelope.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
