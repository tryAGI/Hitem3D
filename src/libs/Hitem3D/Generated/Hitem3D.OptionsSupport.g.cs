...
namespace Hitem3D
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Hitem3D.AutoSDKRetryOptions Retry { get; set; } = new global::Hitem3D.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Hitem3D.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Hitem3D.IAutoSDKHook>();
        ...
        public global::Hitem3D.AutoSDKClientOptions AddHook(
            global::Hitem3D.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Hitem3D.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Hitem3D.AutoSDKClientOptions UseAuthorizationProvider(
            global::Hitem3D.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Hitem3D.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Hitem3D.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Hitem3D.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Hitem3D.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Hitem3D.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Hitem3D.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Hitem3D.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Hitem3D.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Hitem3D.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Hitem3D.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Hitem3D.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Hitem3D.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Hitem3D.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Hitem3D.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Hitem3D.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Hitem3D.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Hitem3D.AutoSDKClientOptions clientOptions,
            global::Hitem3D.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Hitem3D.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Hitem3D.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Hitem3D.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Hitem3D.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Hitem3D.IAutoSDKHook, global::Hitem3D.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Hitem3D.AutoSDKHookContext context)
        {
